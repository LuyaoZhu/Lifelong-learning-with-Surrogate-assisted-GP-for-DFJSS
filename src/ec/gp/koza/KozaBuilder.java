...
public abstract class KozaBuilder extends GPNodeBuilder {
    ...
    protected GPNode fullNode(final EvolutionState state,
        ...
        // features should be different in ordering rule
/*        if (set.name.equals(new String("f2"))) {
            terminals = set.terminals[2];
        }*/
        ...
        // else force a nonterminal unless we have no choice
            ...
            if (triedTerminals)
                warnAboutNoTerminalWithType(type, false, state);        // we tried terminal and we're here because there were none!
