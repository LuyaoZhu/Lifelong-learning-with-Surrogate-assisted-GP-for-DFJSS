...
public class GPIndividual extends Individual
    ...
    public ArrayList<Double> caseFitness; //For LS
    public ArrayList<Double> PCdistance; //For LS

    public ArrayList<Double> realCaseFitness; //For LS

    public Boolean fromLastTask = false;
