...
public class surrogateClearingMultitreeEvaluatorV5 extends SimpleEvaluator {
...
//            multitreeClearingFirst.clearPopulation(state, radius, capacity, phenoCharacterisation);
            ...
            if (nonIntermediatePop) {
                ...
                ((GPRuleEvolutionStateLifelongGPV5) state).normlisePopulation();
                ...
                tempfitnessesForModel = fitnessOneTask;
                tempindsCharListsMultiTree = indsCharListsMultiTreeOneTask;
                nonIntermediatePop = false;


                if (state.generation ==  ((GPRuleEvolutionStateLifelongGPV5) state).generationPerTask - 1 ||
                        state.generation ==  ((GPRuleEvolutionStateLifelongGPV5) state).generationPerTask * 2 - 1  ||
                        state.generation ==  ((GPRuleEvolutionStateLifelongGPV5) state).generationPerTask * 3 - 1 ) {


                    PCFitnessMap.clear();

                    ((GPRuleEvolutionStateLifelongGPV5) state).surrogateSamples.add(indsCharListsMultiTreeOneTask);
                    ((GPRuleEvolutionStateLifelongGPV5) state).surrogateFitness.add(fitnessOneTask);
                }
