...
/**
 * only use the surrogate in the last generation to estimate the fitness of individuals,
 * all individuals
...
public class GPRuleEvolutionStateLifelongGPV2 extends GPRuleEvolutionStateLifelongGPV0 {
    ...
    ArrayList<int[][]> surrogateSamples = new ArrayList<>();
...
//            int[][][] indsCharListsMultiTree = phenotypicForSurrogate.muchBetterPhenotypicPopulationRanks(this,phenoCharacterisation);
            ...
            surrogateSamples.add(indsCharListsMultiTree);
