 ...
 * build surrogate based on 10 unseen instances' real fitness
 *
 * @author luyao
 */

public class GPRuleEvolutionStateLifelongGPV9 extends GPRuleEvolutionStateLifelongGPV8 {
...
//        System.out.println(diversityValue[0]);
        ...
        if (generation == generationPerTask - 1 || generation == generationPerTask * 2 - 1 || generation == generationPerTask * 3 - 1) {
            ...
            int[][] PC = new int[population.subpops[0].individuals.length][PCs[0].length];
