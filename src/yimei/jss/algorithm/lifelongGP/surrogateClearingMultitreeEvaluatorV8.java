...
public class surrogateClearingMultitreeEvaluatorV8 extends SimpleEvaluator {
...
//            multitreeClearingFirst.clearPopulation(state, radius, capacity, phenoCharacterisation);
            ...
            if (nonIntermediatePop) {
                ...
                ((GPRuleEvolutionStateLifelongGPV8) state).normlisePopulation();
                ...
                if(state.generation == ((GPRuleEvolutionStateLifelongGPV8) state).generationPerTask - 1 ||
                        state.generation == ((GPRuleEvolutionStateLifelongGPV8) state).generationPerTask * 2 - 1 ||
                        state.generation == ((GPRuleEvolutionStateLifelongGPV8) state).generationPerTask * 3 - 1) {
