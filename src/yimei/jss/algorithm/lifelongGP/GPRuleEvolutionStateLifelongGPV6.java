...
public class GPRuleEvolutionStateLifelongGPV6 extends GPRuleEvolutionStateLifelongGPV3 {
...
// -------------------------------
            ...
            SimpleKMedoids.Result r = SimpleKMedoids.fit(PCs, (int) (population.subpops[0].individuals.length*seedingRatio), 20160608, 66);
