 ...
 * <p>
 * use lexicase selection to select parents
 *
 * @author luyao
 */

public class GPRuleEvolutionStateLifelongGPV14 extends GPRuleEvolutionStateLifelongGPV3 {
    ...
    public int evolve() {
        ...
        for (int s = 0; s < indsCharListsMultiTree.length; s++) {
            ...
            population.subpops[0].individuals[s].fitness.trials = new ArrayList<>();
        }
...
//        System.out.println(diversityValue[0]);
        ...
        if (generation >= generationPerTask) {
            ...
            for (int t = 0; t < surrogateSamples.size(); t++) {
                estimatedFitness[t] = evaluatePopulation(this, surrogateSamples.get(t), surrogateFitness.get(t), 100);
