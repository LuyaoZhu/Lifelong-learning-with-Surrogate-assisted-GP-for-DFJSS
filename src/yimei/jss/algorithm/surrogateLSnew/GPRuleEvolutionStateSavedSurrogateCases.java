...
public class GPRuleEvolutionStateSavedSurrogateCases extends GPRuleEvolutionState {
    ...
    public static ArrayList<double[]> surrogateFitnessEveryGen = new ArrayList<>();
    public static ArrayList<int[][]> surrogatePCEveryGen = new ArrayList<>();
...
//            for (int a = generation-1; a > generation -16; a--){
//                finalSelectedCasesIndex.add(a);
//            }
