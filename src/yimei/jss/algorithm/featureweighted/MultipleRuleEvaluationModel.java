...
import static yimei.jss.ruleevaluation.MultipleRuleEvaluationModel.P_SIM_BATCH_SIZE;
...
public class MultipleRuleEvaluationModel extends AbstractEvaluationModel{
    ...
    public void setup(final EvolutionState state, final Parameter base) {
        ...
        for (int x = 0; x < numSimModels; x++) {
            ...
            if (batchSize.equals("small")) { // [1,5]
                minBatchSize = 1;
                maxBatchSize = 5;
            } else if (batchSize.equals("medium")) { // [5,15]
                minBatchSize = 5;
                maxBatchSize = 15;
            } else if (batchSize.equals("large")) { // [15,35]
                minBatchSize = 15;
                maxBatchSize = 35;
            }
