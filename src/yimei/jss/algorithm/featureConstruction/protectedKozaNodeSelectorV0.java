...
import static yimei.jss.algorithm.featureConstruction.FeatureConstructionCrossoverPipelineV0.randomSelect;
...
public class protectedKozaNodeSelectorV0 implements GPNodeSelector {
    ...
    public protectedKozaNodeSelectorV0() {
        reset();
    }

    public Object clone() {
        try {
            protectedKozaNodeSelectorV0 s = (protectedKozaNodeSelectorV0) (super.clone());
            s.reset();
            return s;
    ...
    public GPNode pickNode(final EvolutionState s,
        ...
        } else if (rnd > nonterminalProbability)  // pick terminals  //nonterminalProbability = 0.9
        {
            ...
            if (randomSelect == true) {
                ...
                if (FeatureConstructionCrossoverPipelineV0.parent1Flag == true) {
                    for (int a = 0; a < FeatureConstructionCrossoverPipelineV0.parent1ProtectedTerminalsRank.size(); a++) {
                        if (pickedTerminals.contains(FeatureConstructionCrossoverPipelineV0.parent1ProtectedTerminalsRank.get(a)))
                            pickedTerminals.remove(FeatureConstructionCrossoverPipelineV0.parent1ProtectedTerminalsRank.get(a));
                    }
                } else {
                    for (int a = 0; a < FeatureConstructionCrossoverPipelineV0.parent2ProtectedTerminalsRank.size(); a++) {
                        if (pickedTerminals.contains(FeatureConstructionCrossoverPipelineV0.parent2ProtectedTerminalsRank.get(a)))
                            pickedTerminals.remove(FeatureConstructionCrossoverPipelineV0.parent2ProtectedTerminalsRank.get(a));
                    }
                }
            }
            int pickNodeIndex = 0;
        ...
        } else  // pick nonterminals if you can
        {
            ...
            if (nonterminals > 0) // there are some nonterminals
            {
                ...
                if (randomSelect == true) {
                    ...
                    if (FeatureConstructionCrossoverPipelineV0.parent1Flag == true) {
                        for (int a = 0; a < FeatureConstructionCrossoverPipelineV0.parent1ProtectedNonTerminalsRank.size(); a++) {
                            if (pickedNonTerminals.contains(FeatureConstructionCrossoverPipelineV0.parent1ProtectedNonTerminalsRank.get(a)))
                                pickedNonTerminals.remove(FeatureConstructionCrossoverPipelineV0.parent1ProtectedNonTerminalsRank.get(a));
                        }
                    } else {
                        for (int a = 0; a < FeatureConstructionCrossoverPipelineV0.parent2ProtectedNonTerminalsRank.size(); a++) {
                            if (pickedNonTerminals.contains(FeatureConstructionCrossoverPipelineV0.parent2ProtectedNonTerminalsRank.get(a)))
                                pickedNonTerminals.remove(FeatureConstructionCrossoverPipelineV0.parent2ProtectedNonTerminalsRank.get(a));
                        }
                    }
                }
                int pickNodeIndex = 0;
