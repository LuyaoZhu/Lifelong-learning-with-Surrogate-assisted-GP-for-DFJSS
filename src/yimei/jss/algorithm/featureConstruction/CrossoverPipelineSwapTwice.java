...
public class CrossoverPipelineSwapTwice extends GPBreedingPipeline {
    ...
    public CrossoverPipelineSwapTwice() {
    ...
    public Object clone() {
        CrossoverPipelineSwapTwice c = (CrossoverPipelineSwapTwice) (super.clone());
    ...
    public int produce(final int min,
        ...
        for (int q = start; q < n + start; /* no increment */)  // keep on going until we're filled up
        {
           ...
           /* Produces <i>n</i> individuals from the given subpopulation
            ...
            GPNode p1 = null;      // for ind1
            GPNode p2 = null;      // for ind2
