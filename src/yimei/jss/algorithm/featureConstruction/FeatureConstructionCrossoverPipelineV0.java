...
public class FeatureConstructionCrossoverPipelineV0 extends GPBreedingPipeline {
    ...
    public FeatureConstructionCrossoverPipelineV0() {
    ...
    public Object clone() {
        FeatureConstructionCrossoverPipelineV0 c = (FeatureConstructionCrossoverPipelineV0) (super.clone());
...
/*                        int pickedNodeIndex = 0;
                    ...
                    for (int x = 0; x < j1.trees.length; x++) {
                        if (x == t1 && res1)  // we've got a tree with a kicking cross position!
                        {
                            j1.trees[x] = (GPTree) (parents[0].trees[x].lightClone());
                            j1.trees[x].owner = j1;
                            j1.trees[x].child = parents[0].trees[x].child.cloneReplacing(p4, p3);
                            j1.trees[x].child.parent = j1.trees[x];
                            j1.trees[x].child.argposition = 0;
                            j1.evaluated = false;
                        }  // it's changed
