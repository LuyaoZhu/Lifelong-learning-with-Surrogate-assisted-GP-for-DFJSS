 ...
 */
public class FreGPRuleEvolutionStateV3 extends GPRuleEvolutionState {
...
//        protectedKozaNodeSelector.useTime = 0;
        ...
        double duration = (stopTime - beginTime) / 1000;

        System.out.println("过去了 " + duration + " s");

//        for(int a=0; a<FeatureConstructionCrossoverPipeline.casesNum.length; a++){
//            FeatureConstructionCrossoverPipeline.casesNum[a] = 0;
//        }
