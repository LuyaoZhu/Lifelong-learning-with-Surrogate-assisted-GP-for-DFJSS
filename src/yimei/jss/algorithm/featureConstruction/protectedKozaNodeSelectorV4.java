...
public class protectedKozaNodeSelectorV4 implements GPNodeSelector
{
    ...
    public protectedKozaNodeSelectorV4()
    {
        reset();
    }
    ...
    public Object clone()
    {
        try
        {
            protectedKozaNodeSelectorV4 s = (protectedKozaNodeSelectorV4)(super.clone());
            s.reset();
            return s;
        }
                           ...
                           final GPTree tree)
    {
        ...
        else if (rnd > nonterminalProbability)  // pick terminals  //nonterminalProbability = 0.9
        {
            ...
            if(FeatureConstructionCrossoverPipeline.tree1Flag == true){
                for (int a=0; a<FeatureConstructionCrossoverPipeline.tree1ProtectedTerminalsRank.size(); a++){
                    if(pickedTerminals.contains(FeatureConstructionCrossoverPipeline.tree1ProtectedTerminalsRank.get(a)))
                        pickedTerminals.remove(FeatureConstructionCrossoverPipeline.tree1ProtectedTerminalsRank.get(a));
                }
            }
            else {
                for (int a=0; a<FeatureConstructionCrossoverPipeline.tree2ProtectedTerminalsRank.size(); a++){
                    if(pickedTerminals.contains(FeatureConstructionCrossoverPipeline.tree2ProtectedTerminalsRank.get(a)))
                        pickedTerminals.remove(FeatureConstructionCrossoverPipeline.tree2ProtectedTerminalsRank.get(a));
                }
            }
        ...
        else  // pick nonterminals if you can
        {
            ...
            if (nonterminals > 0) // there are some nonterminals
            {
                ...
                if(FeatureConstructionCrossoverPipeline.tree1Flag == true){
                    for (int a=0; a<FeatureConstructionCrossoverPipeline.tree1ProtectedNonTerminalsRank.size(); a++){
                        if(pickedNonTerminals.contains(FeatureConstructionCrossoverPipeline.tree1ProtectedNonTerminalsRank.get(a)))
                            pickedNonTerminals.remove(FeatureConstructionCrossoverPipeline.tree1ProtectedNonTerminalsRank.get(a));
                    }
                }
                else {
                    for (int a=0; a<FeatureConstructionCrossoverPipeline.tree2ProtectedNonTerminalsRank.size(); a++){
                        if(pickedNonTerminals.contains(FeatureConstructionCrossoverPipeline.tree2ProtectedNonTerminalsRank.get(a)))
                            pickedNonTerminals.remove(FeatureConstructionCrossoverPipeline.tree2ProtectedNonTerminalsRank.get(a));
                    }
                }
