...
public class MultipleTreeMultipleRuleEvaluationModelSubCasesV4 extends MultipleTreeMultipleRuleEvaluationModel {
...
/*        if (rules.size() != 2) {
        ...
        if(state.generation >= ((GPRuleEvolutionStateDownSampling)state).switchGen) {
            caseNum = (((GPRuleEvolutionStateDownSamplingV4) state).caseIndex + 1);
        } else {
            caseNum = ((GPRuleEvolutionStateDownSamplingV4) state).caseInOneInstance;
        }
