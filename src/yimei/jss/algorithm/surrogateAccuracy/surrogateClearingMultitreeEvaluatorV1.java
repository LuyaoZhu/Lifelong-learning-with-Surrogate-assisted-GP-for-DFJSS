package yimei.jss.algorithm.surrogateAccuracy;
...
//                System.out.println(distanceRank);
            ...
            PopulationUtils.sort(state.population); //to select the best individual to get PC
...
//            phenoCharacterisation[0] = SequencingPhenoCharacterisation.currentBestRulePhenoCharacterisation((GPRuleEvolutionState) state, problem);
//            phenoCharacterisation[1] = RoutingPhenoCharacterisation.currentBestRulePhenoCharacterisation((GPRuleEvolutionState) state, problem);



            int[][][] indsCharListsMultiTree = phenotypicForSurrogate.muchBetterPhenotypicPopulationRanks(state,phenoCharacterisation);
...
//            double[] diversityValue = new double[state.population.subpops.length];
//            diversityValue[0] = PopulationUtils.entropy(indsCharListsMultiTree);
//            entropyDiversity.add(diversityValue);
//            System.out.println("Entropy diversity: " + diversityValue[0]);

//            for (int i = 0; i < state.population.subpops[0].individuals.length; i++) {
//                GPIndividual ind = (GPIndividual)state.population.subpops[0].individuals[i];
//                ind.PC = indsCharListsMultiTree[i];
//            }
