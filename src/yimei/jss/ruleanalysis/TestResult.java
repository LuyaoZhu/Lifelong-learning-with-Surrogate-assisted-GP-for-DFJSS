...
public class TestResult {
	...
	private List<Fitness> generationalNormalizedTestFitnesses;
	...
	private DescriptiveStatistics generationalAveOrderingRuleSizeStat;
	...
	public TestResult() {
		...
		generationalNormalizedTestFitnesses = new ArrayList<>();
	}
	...
	public Fitness getGenerationalNormalizedTestFitness(int idx) {
		return generationalNormalizedTestFitnesses.get(idx);
	}
	...
	//fzhang 2019.6.1 get the average sequencing rule size into CSV
	//===================================start==================================
	...
	//luyao 2024.10.31 get the average ordering rule size into CSV
	//===================================start==================================
	public DescriptiveStatistics getGenerationalAveOrderingRuleSizeStat() { return generationalAveOrderingRuleSizeStat;	}

	public double getGenerationalAveOrderingRuleSizeStatStat(int gen) {
		return generationalAveOrderingRuleSizeStat.getElement(gen);
	}
	//====================================end===================================
...
//=========================================================================
	...
	public void setGenerationalNormalizedTestFitnesses(List<Fitness> generationalNormalizedTestFitnesses) {
		this.generationalNormalizedTestFitnesses = generationalNormalizedTestFitnesses;
	}
	...
	public void addGenerationalNormalizedTestFitnesses(Fitness f) {
		this.generationalNormalizedTestFitnesses.add(f);
	}
	...
	//31.10.2024 LUYAO read average ordering rule size into CSV
	public void setGenerationalAveOrderingRuleSizeStat(DescriptiveStatistics generationalAveOrderingRuleSizeStat) {
		this.generationalAveOrderingRuleSizeStat = generationalAveOrderingRuleSizeStat;
	}
