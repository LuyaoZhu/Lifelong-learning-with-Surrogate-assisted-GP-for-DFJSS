...
public class Job implements Comparable<Job> {
    ...
    public double workLoadRemaining;

    public int operationRemaining;
...
//        }
    ...
    public String toString() {
        String string = String.format("Job %d, Batch %d, arrives at %.1f, due at %.1f, weight is %.1f. It has %d operations:\n",
                id, batch.getId(), arrivalTime, dueDate, weight, operations.size());
    ...
    public boolean priorTo(Job other) {
