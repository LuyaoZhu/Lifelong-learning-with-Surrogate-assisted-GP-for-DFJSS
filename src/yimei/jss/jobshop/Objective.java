...
public enum Objective {
    ...
    //Objectives for batch
    BATCH_MEAN_WEIGHTED_TARDINESS("batch-mean-weighted-tardiness"),
    BATCH_MEAN_FLOWTIME("batch-mean-flowtime"),
    BATCH_MAX_FLOWTIME("batch-max-flowtime"),
    BATCH_MEAN_TARDINESS("batch-mean-tardiness"),
    BATCH_MAX_WEIGHTED_TARDINESS("batch-max-weighted-tardiness"),
